...
import { CustomRoutesProps } from "./core";
...
export type LegacyAuthProvider = (type: any, params?: any) => Promise<any>;
...
export type ResourceWithRegisterFunction = {
  registerResource: (
    props: ResourceProps,
    permissions: any
  ) => ResourceDefinition;
};
export type RoutesAndResources = {
